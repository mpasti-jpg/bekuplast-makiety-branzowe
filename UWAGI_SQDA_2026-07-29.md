# Uwagi SQD Alliance (Maja Podsiadło) z 29.07.2026 – rejestr rundy
...
## A. UWAGI – komplet z kotwicami (14)

### Strona #02 Przetwórstwo żywności (6) – wszystkie o PFAS (art. 5 ust. 5)

| # | Kotwica (nasz tekst) | Uwaga Mai | Istota |
|---|---|---|---|
| U1 | „w **określonych** [opakowaniach…]" (tekst Moniki w.91 z 7.07) | „W **każdych** opakowaniach przeznaczonych do kontaktu z żywnością" | brak wyłączeń podmiotowych/typów |
| U2 | „**Do 2030 r.**" (tekst Moniki w.69) | „**Od 1.01.2030**" | cele art. 29 wiążą OD daty, nie „do" |
| U3 | „w **wybranych** [opakowaniach…]" (tekst Moniki w.88) | „Nie ma wyłączenia dla rodzajów opakowań" + cytat art. 5 ust. 5 verbatim | jw. U1 |
| U4 | „Dotyczy m.in. papieru tłuszczoodpornego, powłok barierowych, pudełek na frytki i kubków" | „Ograniczenie dotyczy **wszystkich** opakowań przeznaczonych do kontaktu z żywnością" | przykłady nie mogą sugerować zamkniętej listy |
| U5 | „dotyczy **dodatków** per- i polifluoroalkilowych" | „Przepisy nie mówią tylko o «dodatkach», lecz o **stężeniu** PFAS w opakowaniu – w **jakiejkolwiek formie** (składniki materiału, powłoki, dodatki), **jeśli przekraczają określone limity**" | model progowy, nie kategoria „dodatki" |
| U6 | FAQ: „Papier z powłoką PFAS … **przestaje spełniać wymogi PPWR** z chwilą… od 12 sierpnia 2026" | „Zdanie wprowadza w błąd. **Jeżeli nie będzie przekraczać progów, będzie dopuszczone**" | zakaz ≠ absolutny; progi z art. 5 ust. 5 |
...
| # | Kotwica (nasza treść w appce) | Uwaga Mai | Istota |
|---|---|---|---|
| U8 | hasło **BDO** „Baza Danych Odpadowych" | pełna nazwa: „**Baza danych o produktach i opakowaniach oraz o gospodarce odpadami**" | błędna nazwa rejestru |
...
## B. MAPA WYSTĄPIEŃ (skan 6 lokalizacji, 5.08.2026)

| Wzorzec | Makiety v15 | LP | Blog PL | Audyt v3 | Kalk v4 | **Appka TYPO3 (Kuba)** |
|---|---|---|---|---|---|---|
| U1/U3 „w wybranych/określonych" (PFAS) | **3× (#02)** | 0 | 0 | 0 | 0 | 0 |
| U2 cele „do 2030/2040" | **44×** (wszystkie strony) | 0 | 4× (#05 – częściowo już poprawne „od 1 stycznia 2030") | 9× | 0 | 8× + „(2030)" ×8 |
| U5 „dodatki PFAS" | 1× (#02) | 0 | 0 | 0 | 0 | 0 |
| U6 „przestaje spełniać wymogi" | **1× (#02 FAQ)** | 0 | 0 | 0 | 0 | 0 |
| U8 BDO zła nazwa | 0 | 0 | 0 | **1× (glossary)** | 0 | **5× (glossary PL + catalog SK/HU/CS!)** |
| U9 DoC „producent opakowania" (kontekst wystawcy) | do przeglądu (#01/#06 FAQ) | 0 | 26× (⚠️ większość = „producent opakowań zwrotnych" o bekuplast – NIE ruszać; filtrować kontekst DoC) | **12×** | 0 | **11× + i18n** |
| U11 art. 29(3)→punkty sprzedaży | 0 (na #10 poprawnie: „obejmuje także handel elektroniczny") | 0 | 4× (#08/#11/#14 – brzmienia POPRAWNE, zweryfikowane 11.06; tylko re-check) | **1× intro + glossary + obligation** | 0 | **jw.** |
| U13 „Art. 38–40" | 0 | 0 | 0 | **14×** | 0 | **58× (PL + SK/HU/CS)** |
| U14 „dwa różne dokumenty" | 0 | 0 | 0 | 3× | 0 | 3× + i18n |
| U10 nazwa PPWR „o opakowaniach" | 0 | 0 | 8× = **fałszywy alarm** (to poprawna nazwa POLSKIEJ ustawy w #16) | 2× | 0 | 2× |

**LP: czyste (0 trafień) – bez zmian. Kalkulator (oba źródła): czysty – bez zmian treści** (opcjonalny szlif „(od 2030)" w kartach reuse appki TYPO3).

## C. REKOMENDACJE

1. **Aplikacja TYPO3 (Kuby) – naprawić TERAZ (osobna sesja):** U8–U14 to błędy merytoryczne w narzędziu, które klient klika. Kompletna specyfikacja plik-po-pliku: **`POPRAWKI_APPS_SQDA_2026-07-29.md`** (folder hubowy `claude-code/bekuplast-branze`). Lustrzane poprawki w naszym prototypie v3 – w tej samej sesji lub tuż po (utrzymanie parity).
